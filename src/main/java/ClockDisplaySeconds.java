...
public class ClockDisplaySeconds
{
    ...
    //The constructor should set seconds as a NumberDisplay obkect with 60 as the limit
    ...
    //Implement a constructor that takes 3 parameters, hour, minute, and seconds 
    //The constructor should set hours as a NumberDisplay object with 24 as the limit
    //The constructor should set minutes as a NumberDisplay object with 60 as the limit
    // The constructor should set seconds as a NumberDisplay object with 60 as the limit
    ...
    public void updateDisplay(){ 
     String newDisplay = "";
     newDisplay += hours.getValue();
     newDisplay += ":";
     newDisplay += minutes.getValue();
     newDisplay += ":";
     newDisplay += seconds.getValue();
